...
import { FiMoreVertical, FiMessageSquare, FiX, FiSend, FiEdit2, FiTrash2, FiMapPin, FiClock, FiUser, FiPlus } from "react-icons/fi";
...
const CommunitySection = () => {
  ...
  const handleLike = async (postId) => {
    try {
      const response = await fetch(`http://localhost:8070/commi/${postId}/like`, {
        method: "POST",
      });
  ...
  const handleCommentSubmit = async (postId) => {
    ...
    try {
      const response = await fetch(`http://localhost:8070/commi/${postId}/comments`, {
        method: "POST",
        headers: {
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-20 w-full">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto">
            Connect with others, share your experiences, and be part of our growing community.
          </p>
          <button
                        ...
                        <div className="flex flex-col items-center justify-center pt-7">
                          {formData.photo ? (
                            ...
                            <>
                              ...
                              <p className="pt-1 text-sm text-gray-600">Click to upload a photo</p>
                            </>
                          )}
                        </div>
                        <input 
            ...
            <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl transform transition-all duration-300">
              <div className="p-6">
                ...
                <form onSubmit={handleUpdatePost}>
                  <div className="mb-6">
                    <label className="block text-gray-700 font-medium mb-2">Change Photo</label>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {isLoading && posts.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {posts.map((post) => (
                <div key={post._id} className="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg flex flex-col h-full">
                  ...
                  <div className="p-4 border-b border-gray-100 flex justify-between items-start">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-800 text-sm">{post.email}</h3>
                  ...
                  <div className="p-4 flex-grow">
                    ...
                    <p className="text-gray-700 mb-4 text-sm line-clamp-3">{post.description}</p>
                    ...
                    {post.photo && (
                      <div className="mb-4 rounded-lg overflow-hidden shadow-sm">
                        <img
                          ...
                          onClick={() => window.open(`http://localhost:8070${post.photo}`, '_blank')}
                        />
                      </div>
                    )}
                    ...
                    <div className="flex items-center justify-between border-t border-gray-100 pt-3 mt-auto">
                      <button
                        ...
                        className={`flex items-center space-x-1 px-2 py-1 rounded-lg transition-colors duration-300 ${post.likes > 0 ? 'text-red-500' : 'text-gray-500 hover:text-red-500'}`}
                      >
                        {post.likes > 0 ? (
                      ...
                      <button
                        ...
                        className={`flex items-center space-x-1 px-2 py-1 rounded-lg transition-colors duration-300 ${activeComment === post._id ? 'text-blue-600' : 'text-gray-500 hover:text-blue-600'}`}
                      >
                    ...
                    <div className={`mt-3 ${activeComment === post._id ? 'block' : 'hidden'}`}>
                      {/* Comment Form */}
                      <div className="flex items-start space-x-2 mb-3">
                        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white w-8 h-8 rounded-full flex items-center justify-center font-medium text-xs shadow-sm">
                          {formData.email ? formData.email.charAt(0).toUpperCase() : <FiUser size={12} />}
                        </div>
