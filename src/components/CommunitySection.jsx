...
const CommunitySection = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-purple-50 to-blue-50 min-h-screen">
      <NavigationBar/>
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white py-20 w-full">
        <div className="container mx-auto text-center">
          ...
          <button
            ...
            className="bg-white text-purple-600 px-8 py-3 rounded-full hover:bg-purple-50 transition duration-300 transform hover:scale-105 shadow-lg"
          >
      ...
      <div className="container mx-auto p-4">
        ...
        <div className="text-center mb-8">
          <button
            onClick={() => setShowForm(!showForm)}
            className="bg-purple-600 text-white px-8 py-3 rounded-full hover:bg-purple-700 transition duration-300 transform hover:scale-105 shadow-lg"
          >
        ...
        {/* Form */}
        {showForm && (
          <form onSubmit={handleSubmit} method="post" className="bg-white p-8 rounded-lg shadow-2xl max-w-2xl mx-auto">
            <div className="mb-6">
        ...
        {/* Preview Section */}
        <div className="mt-12">
          <h2 className="text-3xl font-bold mb-8 text-center text-purple-700">Community Posts</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts.map((post, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 relative">
                {/* 3-Dots Menu */}
                ...
                <h1
                  ...
                  className="text-gray-700 font-bold mb-2 cursor-pointer hover:text-purple-600"
                >
                  {post.email}
                </h1>
